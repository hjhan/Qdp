...
namespace Qdp.ComputeService.Data.CommonModels.TradeInfos.Equity
{
	[DataContract]
	[Serializable]
	public class VanillaOptionInfo : OptionInfoBase
    {
        //for on spreadsheet trade construction
        public VanillaOptionInfo(string tradeId):
            base(
                  instrumentType: "VanillaOption",
                  tradeId: tradeId,
