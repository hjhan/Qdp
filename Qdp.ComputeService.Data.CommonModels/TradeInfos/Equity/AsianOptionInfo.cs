...
namespace Qdp.ComputeService.Data.CommonModels.TradeInfos.Equity
{
    [DataContract]
    [Serializable]
    public class AsianOptionInfo: OptionInfoBase
    {
        public AsianOptionInfo(string tradeId):
            base(
        ...
        [DataMember]
        public string AsianType { get; set; }
        [DataMember]
        ...
        [DataMember]
        public string AveragingPeriodStartDate { get; set; }
